...
class NewsLocalDataSource {
  ...
  Future<List<ArticleModel>> getCachedArticles({String? category, int page = 1}) async {
    ...
    for (final key in keys) {
      ...
      if (data != null) {
        final model = ArticleModel.fromJson(jsonDecode(data) as Map<String, dynamic>);
  ...
  Future<void> _seedArticles(Box<String> box) async {
    ...
    final seeds = [
      ArticleModel(
        ...
        description: 'اكتشاف علمي رائد يكشف عن طريقة جديدة لتوليد الطاقة النظيفة باستخدام تقنية الاندماج النووي.',
      ...
      ArticleModel(
        ...
        content: 'Apple has <highlight>unveiled</highlight> its latest smartphone featuring <highlight>groundbreaking</highlight> AI capabilities. The new device <highlight>incorporates</highlight> advanced machine learning processors that enable <highlight>sophisticated</highlight> features never before seen in a smartphone.\n\nThe company\'s CEO described the launch as a <highlight>significant</highlight> milestone, emphasizing how the new technology will <highlight>enhance</highlight> user experience. Industry analysts have <highlight>praised</highlight> the innovation, predicting it will <highlight>influence</highlight> the entire smartphone market.',
        category: 'technology',
        source: 'The Verge',
        imageUrl: '',
        audioUrl: '',
      ...
      ArticleModel(
        ...
        description: 'نجوم السينما العالمية يتألقون على السجادة الحمراء في مهرجان كان.',
