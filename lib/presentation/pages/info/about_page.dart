          ...
          child: SingleChildScrollView(
            ...
            _Section(
              ...
              child: Wrap(
                ...
                children: [
                  _SocialChip(emoji: '🌐', label: t.aboutWebsite),
                  _SocialChip(emoji: '📱', label: t.aboutTwitter),
                  _SocialChip(emoji: '📘', label: t.aboutFacebook),
                  _SocialChip(emoji: '📸', label: t.aboutInstagram),
                ],
              ),
            ),
            const SizedBox(height: AppSpacing.lg),
...
class _SocialChip extends StatelessWidget {
  ...
  const _SocialChip({required this.emoji, required this.label});
